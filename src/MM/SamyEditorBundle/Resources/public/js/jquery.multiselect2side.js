			...
			return this.each(function () {
				...
				var divUpDown =
						"<div class='ms2side__updown'>" +
							"<a class='MoveUp button small' title='Move up selected option'>" + o.labelUp + "</a> " +
							"<a class='MoveDown button small' title='Move down selected option'>" + o.labelDown + "</a>" +
						"</div>";
				...
				if (o.search != false && o.optGroupSearch != false) {
					...
					var	ss = "<input type='text' placeholder='search...'/>";
				...
				var htmlToAdd =
					"<div class='ms2side__div clearfix'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<a class='AddOne button small' title='Add Selected'><i class='fa fa-angle-right'></i></a>" +
							"<a class='AddAll button small' title='Add All'><i class='fa fa-angle-double-right'></i></a>" +
							"<a class='RemoveOne button small' title='Remove Selected'><i class='fa fa-angle-left'></i></a>" +
							"<a class='RemoveAll button small' title='Remove All'><i class='fa fa-angle-double-left'></i></a>")
							:
							("<a class='AddOne button small' title='Add Selected'><i class='fa fa-angle-left'></a>" +
							"<a class='AddAll button small' title='Add All'><i class='fa fa-angle-double-left'></i></a>" +
							"<a class='RemoveOne button small' title='Remove Selected'><i class='fa fa-angle-right'></a>" +
							"<a class='RemoveAll button small' title='Remove All'><i class='fa fa-angle-double-right'></i></a>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
