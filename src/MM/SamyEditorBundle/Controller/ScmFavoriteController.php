...
class ScmFavoriteController extends Controller
{
    public function indexAction($hash, $favNo, Request $request)
    {
        ...
        $scmChannels = $em->getRepository('MM\SamyEditorBundle\Entity\ScmChannel')->findChannelsByScmPackage($scmPackage, 'fav' . $favNo . 'sort');
        ...
        return $this->render('MMSamyEditorBundle:ScmFavorite:index.html.twig', array(
